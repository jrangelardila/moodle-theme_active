...
/**
 * The layout/profile.php for theme_active is defined here.
 *
...
echo $OUTPUT->render_from_template('theme_active/profile', array_merge($templatecontext, $settings->get_footer()));